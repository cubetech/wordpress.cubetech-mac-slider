...
function cubetech_mac_slider_create_post_type() {
	register_post_type('cubetech_mac_slider',
		array(
			'labels' => array(
				'name' => __('Mac Slider'),
			...
			'public' => true,
			'has_archive' => false,
			'rewrite' => array('slug' => 'mac-slider', 'with_front' => false),
			'show_ui' => true,
			'menu_position' => '20',
			'menu_icon' => null,
			'hierarchical' => true,
...
add_action('init', 'cubetech_mac_slider_create_post_type', 99);
